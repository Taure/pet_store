...
registration_changeset(Data, Params) ->
    CS = kura_changeset:cast(pet_store_user, Data, Params,
...
email_changeset(Data, Params) ->
    CS = kura_changeset:cast(pet_store_user, Data, Params, [email]),
